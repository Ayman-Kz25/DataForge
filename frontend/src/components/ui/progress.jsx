...
export function ProgressBar({ value = 0, className, color = 'bg-indigo-600' }) {
  return (
    <div className={cn('h-2 w-full rounded-full bg-gray-100 dark:bg-gray-800 overflow-hidden', className)}>
      <div
